...
public class Location  extends com.borland.scc.webservices.sccentities.entities.NamedEntity  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://scc.segue.com", "Location"));
