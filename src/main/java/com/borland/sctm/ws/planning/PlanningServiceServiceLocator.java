...
public class PlanningServiceServiceLocator extends org.apache.axis.client.Service implements com.borland.sctm.ws.planning.PlanningServiceService {
    ...
    public com.borland.sctm.ws.planning.PlanningService gettmplanning() throws javax.xml.rpc.ServiceException {
    ...
    public com.borland.sctm.ws.planning.PlanningService gettmplanning(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.borland.sctm.ws.planning.TmplanningSoapBindingStub _stub = new com.borland.sctm.ws.planning.TmplanningSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.borland.sctm.ws.planning.PlanningService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.borland.sctm.ws.planning.TmplanningSoapBindingStub _stub = new com.borland.sctm.ws.planning.TmplanningSoapBindingStub(new java.net.URL(tmplanning_address), this);
                _stub.setPortName(gettmplanningWSDDServiceName());
                return _stub;
            }
        }
