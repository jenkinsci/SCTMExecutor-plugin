...
public class ExecutionNode  implements java.io.Serializable {
    ...
    private com.borland.sctm.ws.execution.entities.PropertyValue[] propertyValues;
    ...
    public ExecutionNode(
           int id,
           int kind,
           com.borland.sctm.ws.execution.entities.PropertyValue[] propertyValues) {
           this.id = id;
           this.kind = kind;
     ...
     */
    public com.borland.sctm.ws.execution.entities.PropertyValue[] getPropertyValues() {
        return propertyValues;
    }
     ...
     */
    public void setPropertyValues(com.borland.sctm.ws.execution.entities.PropertyValue[] propertyValues) {
        this.propertyValues = propertyValues;
    }
