...
public class ExecutionWebServiceServiceLocator extends org.apache.axis.client.Service implements com.borland.sctm.ws.execution.ExecutionWebServiceService {
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.borland.sctm.ws.execution.ExecutionWebService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.borland.sctm.ws.execution.TmexecutionSoapBindingStub _stub = new com.borland.sctm.ws.execution.TmexecutionSoapBindingStub(new java.net.URL(tmexecution_address), this);
                _stub.setPortName(gettmexecutionWSDDServiceName());
                return _stub;
            }
        }
