...
public class MainEntitiesServiceLocator extends org.apache.axis.client.Service implements com.borland.sctm.ws.administration.MainEntitiesService {
    ...
    public com.borland.sctm.ws.administration.MainEntities getsccentities() throws javax.xml.rpc.ServiceException {
    ...
    public com.borland.sctm.ws.administration.MainEntities getsccentities(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.borland.sctm.ws.administration.SccentitiesSoapBindingStub _stub = new com.borland.sctm.ws.administration.SccentitiesSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.borland.sctm.ws.administration.MainEntities.class.isAssignableFrom(serviceEndpointInterface)) {
                com.borland.sctm.ws.administration.SccentitiesSoapBindingStub _stub = new com.borland.sctm.ws.administration.SccentitiesSoapBindingStub(new java.net.URL(sccentities_address), this);
                _stub.setPortName(getsccentitiesWSDDServiceName());
                return _stub;
            }
        }
