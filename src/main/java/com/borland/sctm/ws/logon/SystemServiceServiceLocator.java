...
public class SystemServiceServiceLocator extends org.apache.axis.client.Service implements com.borland.sctm.ws.logon.SystemServiceService {
    ...
    private java.lang.String sccsystem_address = "http://www-silkcentral/Services1.0/services/sccsystem";
    ...
    public com.borland.sctm.ws.logon.SystemService getsccsystem(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.borland.sctm.ws.logon.SccsystemSoapBindingStub _stub = new com.borland.sctm.ws.logon.SccsystemSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.borland.sctm.ws.logon.SystemService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.borland.sctm.ws.logon.SccsystemSoapBindingStub _stub = new com.borland.sctm.ws.logon.SccsystemSoapBindingStub(new java.net.URL(sccsystem_address), this);
                _stub.setPortName(getsccsystemWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://www-silkcentral/Services1.0/services/sccsystem", "SystemServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://www-silkcentral/Services1.0/services/sccsystem", "sccsystem"));
        }
